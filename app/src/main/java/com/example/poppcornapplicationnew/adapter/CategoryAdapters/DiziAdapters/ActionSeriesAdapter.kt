...
import com.example.poppcornapplicationnew.diziler_FilmlerFragmentler.diziler.DiziCategories.ActionSeriesFragmentDirections
import com.example.poppcornapplicationnew.entities.tvShowResponse.TVShow
import com.squareup.picasso.Picasso

class ActionSeriesAdapter(
    private val mcontext: Context,
    private val tvShowArrayList: List<TVShow>
) : RecyclerView.Adapter<ActionSeriesAdapter.NesneTutucu>() {
    ...
    override fun onBindViewHolder(holder: NesneTutucu, position: Int) {
        ...
        holder.card.setOnClickListener {
            ...
            val action= ActionSeriesFragmentDirections.actionActionSeriesFragmentToTVShowDetails(nesnem)
