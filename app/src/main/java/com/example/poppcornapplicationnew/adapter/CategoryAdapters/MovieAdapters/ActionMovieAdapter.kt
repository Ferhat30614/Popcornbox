...
import com.example.poppcornapplicationnew.diziler_FilmlerFragmentler.filmler.MovieCategories.ActionMovieFragmentDirections
import com.example.poppcornapplicationnew.entities.movieResponse.Movie
import com.squareup.picasso.Picasso

class ActionMovieAdapter (private val mcontext: Context, private var  movieArraylist:List<Movie>):
    RecyclerView.Adapter<ActionMovieAdapter.NesneTutucu>() {
    ...
    override fun onBindViewHolder(holder: NesneTutucu, position: Int) {
        ...
        holder.Card.setOnClickListener(){
            ...
            val action =ActionMovieFragmentDirections.actionActionMovieFragmentToMovieDetails(nesnem)
