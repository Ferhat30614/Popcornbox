...
import com.example.poppcornapplicationnew.diziler_FilmlerFragmentler.diziler.DiziCategories.ComedySeriesFragmentDirections
import com.example.poppcornapplicationnew.entities.tvShowResponse.TVShow
import com.squareup.picasso.Picasso

class ComedySeriesAdapter (
    private val mcontext: Context,
    private val tvShowArrayList: List<TVShow>
) : RecyclerView.Adapter<ComedySeriesAdapter.NesneTutucu>() {
    ...
    override fun onBindViewHolder(holder: NesneTutucu, position: Int) {
        ...
        holder.card.setOnClickListener {
            ...
            val action= ComedySeriesFragmentDirections.actionComedySeriesFragmentToTVShowDetails(nesnem)
